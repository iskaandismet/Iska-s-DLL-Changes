...
const MissionTypes getMISSION_ARCHITECT();
const MissionTypes getMISSION_CURE();
const MissionTypes getMISSION_INNOCULATE();
const MissionTypes getMISSION_AUTHORITY();
const MissionTypes getMISSION_GOVERNMENT();
const MissionTypes getMISSION_PRESTIGE();

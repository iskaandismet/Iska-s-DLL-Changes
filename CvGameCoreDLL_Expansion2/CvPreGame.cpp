...
const char* ConvertGameOptionTypeToString(GameOptionTypes eOption)
{
	...
	case GAMEOPTION_SPAWNS:
		return "GAMEOPTION_SPAWNS";
	case GAMEOPTION_NO_B_LINING:
		return "GAMEOPTION_NO_B_LINING";
	case GAMEOPTION_DYNAMIC_FOW:
		return "GAMEOPTION_DYNAMIC_FOW";
	case GAMEOPTION_BARBARIAN_CITIES:
		return "GAMEOPTION_BARBARIAN_CITIES";
	...
	case GAMEOPTION_ALT_BARBARIANS:
		return "GAMEOPTION_ALT_BARBARIANS";
	case GAMEOPTION_IGE:
		return "GAMEOPTION_IGE";
	}

...
public:
	...
	void DoVassalageOffer(PlayerTypes ePlayer, DiploStatementTypes& eStatement, CvDeal* pDeal);
	...
	bool IsPlayerAlliancewithAnyFriend(PlayerTypes ePlayer) const;
	bool IsPlayerAlliancewithAnyEnemy(PlayerTypes ePlayer) const;
	...
	int GetAllianceAcceptedScore(PlayerTypes ePlayer);
	int GetAllianceWithAnyFriendScore(PlayerTypes ePlayer);
	int GetAllianceWithAnyEnemyScore(PlayerTypes ePlayer);
